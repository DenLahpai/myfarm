            ...
            <div class="post-item">
				...
				<div class="post-item">
					<div class="comment-input-items">
						...
						<div class="comment-input-item">
							<button type="button" class="btn-comment" id="<? echo "btn-comment".$row_Posts->Id;?>" onclick="postComment('<? echo $row_Posts->Id;?>', 'user_posts.php'); location.reload(true);">Post Comment!</button>
							...
							<div class="comments-items">
								...
								<div class="comment-item">
									...
									<div class="reply" id="<? echo "reply-input".$row_Comments->Id;?>">
										...
										<div>
											<button class="btn-comment" id="<? echo "btn-reply".$row_Comments->Id; ?>" onclick="insertReply('<? echo $row_Comments->Id ;?>', 'user_posts.php'); location.reload(true);">Post Reply!</button>
										</div>
									</div>
									<!-- replies -->
													...
													<div class="comments-item">
														...
														<div class="reply" id="<? echo 're-reply-input'.$row_Replies->Id; ?>">
															...
															<div>
																...
																<button class="btn-comment" style="display: block;" onclick="insertReReply('<? echo $row_Replies->Id; ?>', '<? echo $row_Comments->Id ;?>', 'user_posts.php'); location.reload(true);">Post Reply!</button>
															</div>
														</div>														
													</div>
													<!-- ends here -->
