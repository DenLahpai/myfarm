	...
	<div class="message-menu">
		<div class="message-menu-items">
			<div class="message-menu-item">
				<div onclick="Toggle('message-reply-form');">Reply</div>
			</div>
			<div class="message-menu-item">
				<div onclick="deleteMessage('<? echo $row_Messages->Link; ?>');">Delete</div>
			</div>
		</div>
		<div class="message-reply-form" id="message-reply-form">
			...
			<div>
				<button type="button" class="btn-submit" id="btn-Send" onclick="replyMessage('<? echo $receiver; ?>');">Send</button>
			</div>
		</div>	
	</div>
	<div class="message-container">
		...
		<div class="current-message">
			<div class="message-sender">
				...
				echo "From: <a href=\"view_user.php?UsersLink=$row_Users->Link\" target='_blank' style='cursor: pointer;'>".$row_Users->Username."</a></br>";
				?>
			</div>
		...
		<?php foreach ($rows_all_conversation as $row_all_conversation): ?>
			<?php if ($row_all_conversation->Created < $current_message_time): ?>
				...
				echo "From: <a href=\"view_user.php?UsersLink=$row_Users->Link\" target='_blank' style='cursor: pointer;'>".$row_Users_conversation->Username."</a></br>";
				echo "Subject: ".$row_all_conversation->Subject."<br>";
				echo "On: ".date('d-M-Y H:i', strtotime($row_all_conversation->Created))."<br><br>";
				?>
